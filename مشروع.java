...
public class ãÔÑæÚ {
	...
	public static void main(String[] args) {
		...
		System.out.print("\n" + "ÇáãËáË ãÓÇÍÉ ÍÓÇÈ-3");
		System.out.print("\n" + "áÇ Çã Çæáí ÇáÑŞã ßÇä ÇĞÇ ÊÊÃßÏ Çä æÊÑíÏ ÑŞã áÏíß-4");
		System.out.print("\n" + "ÇáİÑÏíÉ Çæ ÇáÒæÌíÉ ÇáÇÑŞÇã ãä ãÌãæÚÉ ÇäÔÇÁ ÊÑíÏ-5");
		System.out.print("\n" + "ÇáÔåíÑÉ ÇáÈÑãÌÉ ÈáÛÇÊ ãÕİæİÉ ØÈÇÚÉ ÊÑíÏ-6");
		System.out.print("\n" + "\n" + "ÊäİíĞåÇ ÇáãÑÇÏ ÇáÚãáíÉ ÑŞã ÇÏÎá: ");
		...
		if (i == 1) {
			...
			System.out.print("ÇáÏÇÆÑÉ ŞØÑ äÕİ ÇÏÎá:");
			double circle = red.nextInt();
			System.out.print("ÇáÏÇÆÑÉ ãÓÇÍÉ: " + (Math.PI * Math.pow(circle, 2)));
		}

		else if (i == 3) {
			System.out.print("ÇáŞÇÚÏÉ Øæá ÇÏÎá: ");
			int base = red.nextInt();

			System.out.print("ÇáãËáË ÇÑÊİÇÚ ÇÏÎá:");
			...
			System.out.print("3 ãä ÇßÈÑ ÑŞã ÇÏÎá: ");
			...
			System.out.print("ÇáİÑÏíÉ æ ÇáÒæÌíÉ ááÇÑŞÇã ÇáÇÚáì ÇáÍÏ ÇÏÎá: ");
			...
			System.out.println(" " + "\n");// ÇáİÑÏíÉ æ ÇáÒæÌíÉ ÇáÇÑŞÇã Èíä ãÓÇİÉ
